        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              <th className="min-w-[140px] py-4 px-4 font-medium text-black dark:text-white xl:pl-5">
                Created At
              </th>
              <th className="min-w-[170px] py-4 font-medium text-black dark:text-white xl:pl-6">
                Name
              </th>
